...
if str2double(NodeIndex) == 1
    ...
    if str2double(NodeIndex) <= 10
        ...
        elseif FlagTrVal == 2
            EstClassPre = load(['Experiments' ExperimentsIndex '\Cascade-LAC\Node0' num2str(str2double(NodeIndex)-1) '\Validation\ResultsOfClassifyingTrEyePatchesSBDA_Node0' num2str(str2double(NodeIndex)-1) '.dat']);
        end
    else
        if FlagTrVal == 1
        ...
        elseif FlagTrVal == 2
            EstClassPre = load(['Experiments' ExperimentsIndex '\Cascade-LAC\Node' num2str(str2double(NodeIndex)-1) '\Validation\ResultsOfClassifyingTrEyePatchesSBDA_Node' num2str(str2double(NodeIndex)-1) '.dat']);
        end
    end
end
...
if str2double(NodeIndex) == 1
    ...
    if str2double(NodeIndex) <= 10
        if FlagTrVal == 1
            EstClassPre = load(['Experiments' ExperimentsIndex '\Cascade-LAC\Node0' num2str(str2double(NodeIndex)-1) '\Training\ResultsOfClassifyingValEyePatchesSBDA_Node0' num2str(str2double(NodeIndex)-1) '.dat']);
        elseif FlagTrVal == 2
        ...
        if FlagTrVal == 1
            EstClassPre = load(['Experiments' ExperimentsIndex '\Cascade-LAC\Node' num2str(str2double(NodeIndex)-1) '\Training\ResultsOfClassifyingValEyePatchesSBDA_Node' num2str(str2double(NodeIndex)-1) '.dat']);
        elseif FlagTrVal == 2
