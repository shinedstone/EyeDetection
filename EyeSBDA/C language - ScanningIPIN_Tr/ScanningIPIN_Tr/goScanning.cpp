...
{	
	...
	sprintf(pathImages,"D:\\EyeSBDA\\Images-Training\\");
	//sprintf(pathImages,"D:\\EyeSBDA\\TestImages\\");
	//sprintf(pathImages,"D:\\EyeSBDA\\TestImages2\\");
	//sprintf(pathImages,"D:\\EyeSBDA\\TestImages3\\");

	sprintf(pathOutput1,"D:\\EyeSBDA\\Experiments%s\\Cascade-LAC\\Node%s\\Training\\",ExperimentStr,NodeStr);
	sprintf(pathOutput2,"ResultsOfScanningLAC\\");
	
	nImages = NUM_IMAGES;
	
	FILE *FP_EyeCoord;
	sprintf(StrTemp,"D:\\EyeSBDA\\Tr_Eye_Coord.dat");
	//sprintf(StrTemp,"D:\\EyeSBDA\\Total_Eye_Coord.dat");
	//sprintf(StrTemp,"D:\\EyeSBDA\\Total_Eye_Coord2.dat");
	//sprintf(StrTemp,"D:\\EyeSBDA\\Total_Eye_Coord3.dat");
