...
if str2double(NodeIndex) < 9
    if FlagTrVal == 1
        FolderPath = ['Experiments' ExperimentsIndex '\Cascade-BDA\Node' NodeIndex '\Training\NegativeSamples'];
        OutFolderPath = ['Experiments' ExperimentsIndex '\Cascade-BDA\Node0' num2str(str2double(NodeIndex)+1) '\Training\NegativeSamples'];
    elseif FlagTrVal == 2
        FolderPath = ['Experiments' ExperimentsIndex '\Cascade-BDA\Node' NodeIndex '\Validation\NegativeSamples'];
        OutFolderPath = ['Experiments' ExperimentsIndex '\Cascade-BDA\Node0' num2str(str2double(NodeIndex)+1) '\Validation\NegativeSamples'];
    end
elseif str2double(NodeIndex) >= 9
    if FlagTrVal == 1
        FolderPath = ['Experiments' ExperimentsIndex '\Cascade-BDA\Node' NodeIndex '\Training\NegativeSamples'];
        OutFolderPath = ['Experiments' ExperimentsIndex '\Cascade-BDA\Node' num2str(str2double(NodeIndex)+1) '\Training\NegativeSamples'];
    elseif FlagTrVal == 2
        FolderPath = ['Experiments' ExperimentsIndex '\Cascade-BDA\Node' NodeIndex '\Validation\NegativeSamples'];
        OutFolderPath = ['Experiments' ExperimentsIndex '\Cascade-BDA\Node' num2str(str2double(NodeIndex)+1) '\Validation\NegativeSamples'];
    end
end
...
for k=1:nNonEyes
    ...
    DistFromPosMean = sqrt( (TrainProj(1:nBDA)-MeanPosProj(1:nBDA)) * (TrainProj(1:nBDA)-MeanPosProj(1:nBDA))' );
