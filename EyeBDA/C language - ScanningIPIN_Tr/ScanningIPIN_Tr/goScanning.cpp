...
{	
	...
	//sprintf(pathImages,"D:\\EyeBDA\\Images-Training\\");
	//sprintf(pathImages,"D:\\EyeBDA\\TestImages\\");
	//sprintf(pathImages,"D:\\EyeBDA\\TestImages2\\");
	sprintf(pathImages,"D:\\EyeBDA\\TestImages3\\");

	sprintf(pathOutput1,"D:\\EyeBDA\\Experiments%s\\Cascade-LAC\\Node%s\\Training\\",ExperimentStr,NodeStr);
	sprintf(pathOutput2,"ResultsOfScanningLAC\\");
	
	nImages = NUM_IMAGES;
	
	FILE *FP_EyeCoord;
	//sprintf(StrTemp,"D:\\EyeBDA\\Tr_Eye_Coord.dat");
	//sprintf(StrTemp,"D:\\EyeBDA\\Total_Eye_Coord.dat");
	//sprintf(StrTemp,"D:\\EyeBDA\\Total_Eye_Coord2.dat");
	sprintf(StrTemp,"D:\\EyeBDA\\Total_Eye_Coord3.dat");
