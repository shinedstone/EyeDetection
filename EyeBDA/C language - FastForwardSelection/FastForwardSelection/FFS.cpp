...
#define		MAX_NUM_HAARFEATS		5

char ExperimentsIndex[] = "01";
char NodeIndex[] = "01";
...
void main()
{
	...
	TimeStart = clock();
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\VMatForFFS_Node%s_1of4.dat",ExperimentsIndex,NodeIndex,NodeIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\VMatForFFS_Node%s_2of4.dat",ExperimentsIndex,NodeIndex,NodeIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\VMatForFFS_Node%s_3of4.dat",ExperimentsIndex,NodeIndex,NodeIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\VMatForFFS_Node%s_4of4.dat",ExperimentsIndex,NodeIndex,NodeIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\ThetaAndPOfHaarFeat_Node%s_1of4.dat",ExperimentsIndex,NodeIndex,NodeIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\ThetaAndPOfHaarFeat_Node%s_2of4.dat",ExperimentsIndex,NodeIndex,NodeIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\ThetaAndPOfHaarFeat_Node%s_3of4.dat",ExperimentsIndex,NodeIndex,NodeIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\ThetaAndPOfHaarFeat_Node%s_4of4.dat",ExperimentsIndex,NodeIndex,NodeIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\HaarFeatInfo18x18.dat",ExperimentsIndex);
	...
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\%s_Node%s.dat",ExperimentsIndex,NodeIndex,FileName1,NodeIndex);
	FILE *FP_HaarFeats = fopen(StrTemp,"wt");
	fprintf(FP_HaarFeats,"Type   SizeY   SizeX   StartY   StartX   Polarity\n");
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\%s_Node%s.dat",ExperimentsIndex,NodeIndex,FileName2,NodeIndex);
	FILE *FP_FeatOutPut = fopen(StrTemp,"wt");
	sprintf(StrTemp,"D:\\EyeBDA\\Experiments%s\\Cascade-BDA\\Node%s\\Training\\%s_Node%s.dat",ExperimentsIndex,NodeIndex,FileName3,NodeIndex);
