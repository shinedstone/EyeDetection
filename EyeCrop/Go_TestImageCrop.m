...
for i = 1 : end_idx,
    ...
    fprintf(fid_out,'%d %d %d %d %d %d %f \n', leye_Y, leye_X, leye_Y - WinSize, leye_X - WinSize, leye_Y + WinSize, leye_X + WinSize, distance );
    fprintf(fid_out,'%d %d %d %d %d %d %f \n', reye_Y, reye_X, reye_Y - WinSize, reye_X - WinSize, reye_Y + WinSize, reye_X + WinSize, distance );
