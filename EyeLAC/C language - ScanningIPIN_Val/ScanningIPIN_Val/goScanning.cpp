...
{	
	...
	double Dist1, Dist2, Dist3, PatchScore1, PatchScore2, TimeStart, TimeEnd, TempDouble, Distance;
	...
	sprintf(pathImages,"D:\\EyeDetection\\Images-Validation\\");
	sprintf(pathOutput1,"D:\\EyeDetection\\Experiments%s\\Cascade-LAC\\Node%s\\Validation\\",ExperimentStr,NodeStr);
	sprintf(pathOutput2,"ResultsOfScanningLAC\\");
	
	nImages = NUM_IMAGES;

	FILE *FP_EyeCoord;
	sprintf(StrTemp,"D:\\EyeDetection\\Val_Eye_Coord.dat");
